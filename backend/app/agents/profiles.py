...
class AgentProfile:
    ...
    def system_prompt(self) -> str:
        ...
        return (
            ...
            "7. criteria_scores를 0.4~0.6 사이로 뭉뚱그리지 마라. 각 기준을 독립적으로, 그 기준 하나만\n"
            "   놓고 얼마나 강한지/약한지 채점하라. 기준: 0.8~1.0=명백히 강함(직접 일치하는 근거 다수),\n"
            "   0.6~0.8=양호, 0.4~0.6=중립적이거나 판단할 근거 자체가 빈약함, 0.2~0.4=약함(부정적 근거 존재),\n"
            "   0.0~0.2=명백히 결격/불가. 네 기준 전부가 비슷한 점수로 몰리면 위원회가 위원별 관점을 구분할\n"
            "   수 없게 되므로, 실제로 강한 기준과 약한 기준의 점수 차이를 뚜렷하게 벌려라.\n"
